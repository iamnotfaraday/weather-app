    ...
    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className={`bg-gradient-to-br ${getWeatherGradient(weather.weather[0].icon)} rounded-3xl p-8 text-center relative overflow-hidden`}>
        ...
        <div className="relative z-10">
          ...
          <div className="flex justify-center gap-8 mt-6 pt-2 border-t border-neutral-200/50">
            <div className="text-center">
              <p className="text-neutral-400 text-xs uppercase tracking-wider mb-1">纬度</p>
              <p className="text-xl font-medium text-neutral-700">{weather.coord.lat}°</p>
            </div>
            <div className="text-center">
              <p className="text-neutral-400 text-xs uppercase tracking-wider mb-1">经度</p>
              <p className="text-xl font-medium text-neutral-700">{weather.coord.lon}°</p>
            </div>
          </div>
        </div>
      </div>
